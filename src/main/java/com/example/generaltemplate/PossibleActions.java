...
public enum PossibleActions {
    ...
    STRAIGHT_SWORD(new Action("Straight sword", ActionGroupings.WEAPONS,
            new StatModifier("Straight sword", new Stats(0, 15, 0, 0, 0)),
    ...
    MEDIUM_ARMOR (new Action("Medium Armor", ActionGroupings.ARMOR,
                  new StatModifier("Medium armor", 1, new Stats(0, 0, 15, 0, 0)),
            "Middle of the pack\n+15 defense", 100)),
    AWESOME_ARMOR (new Action("Awesome armor", ActionGroupings.ARMOR,
            new StatModifier("Awesome armor", 1, new Stats(0, 0, 20, 5, 0)),
            "Armor that's pretty awesome\n+20 defense and +5 awesomeness", 100));
